...
variational version: Decoder dnn -> grustack
"""
...
class JointEncoderGRU(tf.keras.Model):
    def __init__(self, z_size, hidden_sizes=(64, 64), transpose=False, **kwargs):
        ...
        self.z_size = int(z_size)
        self.net = make_GRUExp_Encoder(2*z_size, hidden_sizes)
...
class BandedJointEncoderGRU(tf.keras.Model):
    def __init__(self, z_size, hidden_sizes=(64, 64), data_type=None, transpose=False, **kwargs):
        ...
        self.z_size = int(z_size)
        self.net = make_GRUExp_Encoder(3*z_size, hidden_sizes)
...
class Decoder(tf.keras.Model):
    def __init__(self, output_size, hidden_sizes=(64, 64)):
        ...
        self.net = make_GRUExp_Decoder(output_size, hidden_sizes)
...
class VAE(tf.keras.Model):
    ...
    def get_trainable_vars(self):
        self.compute_loss(x=tf.random.normal(shape=(1, self.time_length, self.data_dim), dtype=tf.float32),
                          y=tf.random.normal(shape=(1, self.time_length, self.data_dim), dtype=tf.float32),
