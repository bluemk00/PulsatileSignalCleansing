...
np.save('../Models/TrainDataSet/MIMIC_ART_TrSet.npy', TrSet_ART)
np.save('../Models/TrainDataSet/MIMIC_ART_ValSet.npy', ValSet_ART)
...
np.save('../Models/TrainDataSet/MIMIC_PPG_TrSet.npy', TrSet_PPG)
np.save('../Models/TrainDataSet/MIMIC_PPG_ValSet.npy', ValSet_PPG)
