# added one artifact type to 6.1 (no overlap)
...
if __name__ == "__main__":
    ...
    with strategy.scope():
        ...
        SaveFilePath = '../4.TrainedModel/7.3_depth50_overlap0/7.3.EdgePred2_{epoch:d}_ABPd{ABPOut_diff_loss:.5f}_valABPd{val_ABPOut_diff_loss:.5f}_ABP{ABPOut_loss:.5f}_valABP{val_ABPOut_loss:.5f}.hdf5'
