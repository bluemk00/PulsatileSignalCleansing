...
if __name__ == "__main__":
    ...
    ## Data selection
    TrSet = np.load('D:/Dropbox/AICleansing_ver2/2.ProcessedData/main_final_modeltraining_dataset/TrSet_MIMIC_ART_ver3.npy')[:] 
    ValSet = np.load('D:/Dropbox/AICleansing_ver2/2.ProcessedData/main_final_modeltraining_dataset/ValSet_MIMIC_ART_ver3.npy')[:]     
    ...
    with strategy.scope():
        ...
        # AEModel.load_weights('../4.TrainedModel/final_7.0_depth50_overlap40/7.0.EdgePred2_6317_AMP0.00043_valAMP0.00052_ABPd0.00578_valABPd0.00631_ABP0.00067_valABP0.00086.hdf5')
        ...
        SaveFilePath = '../4.TrainedModel/final_ver3_7.0_depth50_overlap40/AE_ABPABPdAMP_{epoch:04}_val{val_loss:.7f}_valABP{val_ABPOut_loss:.7f}_valABPd{val_ABPOut_diff_loss:.7f}_valAMP{val_AmplitudeOut_loss:.7f}_tr{loss:.7f}_ABP{ABPOut_loss:.7f}_ABPd{ABPOut_diff_loss:.7f}_AMP{AmplitudeOut_loss:.7f}.hdf5'
