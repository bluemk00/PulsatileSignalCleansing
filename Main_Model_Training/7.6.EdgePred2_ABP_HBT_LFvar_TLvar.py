...
#         print('1',OutAmplitude.shape)
        ...
        return (InpData), (OutpData, shtr) # (InpData), (OutpData) 
...
if __name__ == "__main__":
    ...
    with strategy.scope():
        ...
        AEModel = Model(InpL, (ABPOut, HBTOut))

        # AEModel.load_weights('../4.TrainedModel/final_7.6_depth50_overlap40/7.6.EdgePred2_114_ABP0.00076_valABP0.00075_HBT0.00072_valHBT0.00071.hdf5')
        ...
        SaveFilePath = '../4.TrainedModel/final_ver2_7.6_depth50_overlap40/AE_ABPHBT_{epoch:04}_val{val_loss:.7f}_valABP{val_ABPOut_loss:.7f}_valHBT{val_HBTOut_loss:.7f}.hdf5'
        ...
        AEModel.compile(loss={'ABPOut':'mse','HBTOut':DistCost}, optimizer=adam)
