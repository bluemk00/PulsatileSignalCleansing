...
if __name__ == "__main__":
    ...
    with strategy.scope():
        ...
        SaveFilePath = '../4.TrainedModel/7.1.2_depth50_overlap0/7.1.2.EdgePred2_{epoch:d}_AMP{AmplitudeOut_loss:.5f}_valAMP{val_AmplitudeOut_loss:.5f}_ABPd{ABPOut_diff_loss:.5f}_valABPd{val_ABPOut_diff_loss:.5f}_ABP{ABPOut_loss:.5f}_valABP{val_ABPOut_loss:.5f}.hdf5'
