...
#         print('2',AmplitudeOut.shape)
        AmplitudeOut= Reshape((-1,),name='AmplitudeOut')(AmplitudeOut)
#         print('3',AmplitudeOut.shape)
#         print('4',AmplitudeOut[:,1:].shape)

        AEModel = Model(InpL, (ABPOut, ABPOut_diff, AmplitudeOut))
        AEModel.load_weights('../4.TrainedModel/6.2_depth50_overlap40/6.2.EdgePred2_2617_AMP0.00034_valAMP0.00028_ABPd0.00486_valABPd0.00393_ABP0.00053_valABP0.00047.hdf5')
        ...
        SaveFilePath = '../4.TrainedModel/6.2_depth50_overlap40/6.2.EdgePred2_{epoch:d}_AMP{AmplitudeOut_loss:.5f}_valAMP{val_AmplitudeOut_loss:.5f}_ABPd{ABPOut_diff_loss:.5f}_valABPd{val_ABPOut_diff_loss:.5f}_ABP{ABPOut_loss:.5f}_valABP{val_ABPOut_loss:.5f}.hdf5'
        ...
        earlystopper = EarlyStopping(monitor='val_loss', patience=3000, verbose=1,restore_best_weights=True)
        history = LossHistory()
