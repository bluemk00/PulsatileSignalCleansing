...
class DataBatch(tf.keras.utils.Sequence):
    ...
    def __getitem__(self, idx):
        ...
        return (InpData), (OutpData, OutpData_diff, OutMean, OutAmplitude) # (InpData), (OutpData) 
...
if __name__ == "__main__":
    ...
    with strategy.scope():
        ...
        AEModel = Model(InpL, (ABPOut, ABPOut_diff, MeanOut, AmplitudeOut))
        # AEModel.load_weights('./6.1.2.EdgePred2_ABP_ABPDiffRmse_LFvar_TLvar/EdgePred2_127_0.00376_0.00499_0.00371_0.00461_0.00580_0.00760_0.00019_0.00028.hdf5')
        ...
        SaveFilePath = '../4.TrainedModel/6.1.2_depth50_overlap40/6.1.2.EdgePred2_{epoch:d}_ABP{ABPOut_loss:.5f}_valABP{val_ABPOut_loss:.5f}_ABPd{ABPOut_diff_loss:.5f}_valABPd{val_ABPOut_diff_loss:.5f}_Mean{MeanOut_loss:.5f}_valMean{val_MeanOut_loss:.5f}_AMP{AmplitudeOut_loss:.5f}_valAMP{val_AmplitudeOut_loss:.5f}.hdf5'
        ...
        AEModel.compile(loss={'ABPOut':MSEtop,'ABPOut_diff':RMSE,'MeanOut':RMSE,'AmplitudeOut':Amplitudetop}, optimizer=adam) #loss={'AmplitudeOut':AmplitudeCost,'ABPOut':'mse'}
