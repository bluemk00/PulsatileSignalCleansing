...
if __name__ == "__main__":
    ...
    ## Data selection
    TrSet = np.load('D:/Dropbox/AICleansing_ver2/2.ProcessedData/main_final_modeltraining_dataset/TrSet_MIMIC_ART_ver2.npy')[:] 
    ValSet = np.load('D:/Dropbox/AICleansing_ver2/2.ProcessedData/main_final_modeltraining_dataset/ValSet_MIMIC_ART_ver2.npy')[:]     

    print('************************************************')
    print('    Train set total N size   ',TrSet.shape[0])
    print('    Valid set total N size   ',ValSet.shape[0])
    print('************************************************')
    ...
    with strategy.scope():
        ...
        # AEModel.load_weights('../4.TrainedModel/final_7.5_depth50_overlap40/7.5.EdgePred2_5851_ABP0.00073_valABP0.00089_ABPd0.00630_valABPd0.00681_HBT0.00066_valHBT0.00083.hdf5')
        ...
        SaveFilePath = '../4.TrainedModel/final_ver2_7.5_depth50_overlap40/AE_ABPABPdHBT_{epoch:04}_val{val_loss:.7f}_valABP{val_ABPOut_loss:.7f}_valABPd{val_ABPOut_diff_loss:.7f}_valHBT{val_HBTOut_loss:.7f}.hdf5'
        ...
        AEModel.compile(loss={'ABPOut':'mse','ABPOut_diff':RMSE,'HBTOut':DistCost}, optimizer=adam)
