...
#         HBTOut = Reshape((-1,),name='HBTOut')(HBTOut)
        ...
        # AEModel.load_weights('./6.1.3.extra/6.1.3.EdgePred2_150_0.00048_0.00058_0.00405_0.00487_0.00043_0.00052.hdf5')
...
#             print(MSAD)
        ...
        SaveFilePath = '../4.TrainedModel/6.1.3_depth50_overlap40/6.1.3.EdgePred2_{epoch:d}_ABP{ABPOut_loss:.5f}_valABP{val_ABPOut_loss:.5f}_ABPd{ABPOut_diff_loss:.5f}_valABPd{val_ABPOut_diff_loss:.5f}_HBT{HBTOut_loss:.5f}_valHBT{val_HBTOut_loss:.5f}.hdf5'
