...
#         AmplitudeOut= Reshape((-1,),name='AmplitudeOut')(AmplitudeOut)
        ...
        # AEModel.load_weights('./6.1.EdgePred2_ABP_ABPDiffRmse_LFvar_TLvar/EdgePred2_2881_0.00333_0.00439_0.00036_0.00049.hdf5')
        ...
        SaveFilePath = '../4.TrainedModel/6.1_depth50_overlap40/6.1.EdgePred2_{epoch:d}_ABPd{ABPOut_diff_loss:.5f}_valABPd{val_ABPOut_diff_loss:.5f}_ABP{ABPOut_loss:.5f}_valABP{val_ABPOut_loss:.5f}.hdf5'
