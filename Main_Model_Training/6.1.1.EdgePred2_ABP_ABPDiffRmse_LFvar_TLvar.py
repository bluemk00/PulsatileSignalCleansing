...
#         AmplitudeOut= Reshape((-1,),name='AmplitudeOut')(AmplitudeOut)
        ...
        # AEModel.load_weights('6.1.1/6.1.1.EdgePred2_1179_0.00532_0.00560_0.00054_0.00062.hdf5')
        ...
        SaveFilePath = '../4.TrainedModel/6.1.1_depth50_overlap40/6.1.1.EdgePred2_{epoch:d}_ABPd{ABPOut_diff_loss:.5f}_valABPd{val_ABPOut_diff_loss:.5f}_ABP{ABPOut_loss:.5f}_valABP{val_ABPOut_loss:.5f}.hdf5'
