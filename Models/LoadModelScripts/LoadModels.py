...
sys.path.append('../../lib/')
sys.path.append('../../Models/Benchmarks/')
sys.path.append('../../Models/Ours/')
...
from ModelStructure import build_model_structure

# Load models and their weights
def load_models():
    # Build and load DI models
    DI = build_model_structure(2)
    DI.build(input_shape=(None, 500, 2))  # Build the model with the correct input shape
    DI.load_weights('../../Models/BestModels/ABP/DI.hdf5')

    DI_D = build_model_structure(1)
    DI_D.build(input_shape=(None, 500, 1))  # Build the model with the correct input shape
    DI_D.load_weights('../../Models/BestModels/ABP/DI_D.hdf5')

    DI_A = build_model_structure(0)
    DI_A.build(input_shape=(None, 500, 1))  # Build the model with the correct input shape
    DI_A.load_weights('../../Models/BestModels/ABP/DI_A.hdf5')
    ...
    HIVAE.encoder.net.load_weights('../../Models/BestModels/ABP/HIVAE_encoder.hdf5')
    HIVAE.decoder.net.load_weights('../../Models/BestModels/ABP/HIVAE_decoder.hdf5')
    ...
    optimizer = tf.compat.v1.train.AdamOptimizer(learning_rate=1e-3)
    GPVAE.encoder.net.load_weights('../../Models/BestModels/ABP/GPVAE_encoder.hdf5')
    GPVAE.decoder.net.load_weights('../../Models/BestModels/ABP/GPVAE_decoder.hdf5')
    ...
    SNM.load_weights('../../Models/BestModels/ABP/SNM.hdf5')
    ...
    BDC.compile(loss='mse', optimizer = 'adam')
    BDC.load_weights('../../Models/BestModels/ABP/BDC.hdf5')
